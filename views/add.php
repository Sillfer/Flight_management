                        ...
                        <div class="col-md-12 col-lg-12 d-flex align-items-center">
                            <div class="card-body p-4 p-lg-5 text-black">
                                ...
                                <form method="post">
                                    ...
                                    <h5 class="fw-normal mb-3 pb-3" style="letter-spacing: 1px;">Add Flight</h5>

                                    <div class="form-outline mb-4">
                                        <input type="text" name="origin" placeholder="Origin" class="form-control form-control-lg" required />
                                        <label for="origin" class="form-label">Origin</label>
                                    </div>

                                    <div class="form-outline mb-4">
                                        <input type="text" name="destination" placeholder="Destination" class="form-control form-control-lg" required />
                                        <label for="destination" class="form-label">Destination</label>
                                    </div>

                                    <div class="form-outline mb-4">
                                        <input type="datetime-local" name="dep_time" placeholder="Departure Time" class="form-control form-control-lg" required />
                                        <label for="dep_time" class="form-label">Departure Time</label>
                                    </div>

                                    <div class="form-outline mb-4">
                                        <input type="datetime-local" name="return_time" placeholder="Return Time" class="form-control form-control-lg" required />
                                        <label for="return_time" class="form-label">Arrival Time</label>
                                    </div>

                                    <div class="form-outline mb-4">
                                        <input type="text" name="seats" placeholder="Seats" class="form-control form-control-lg" required />
